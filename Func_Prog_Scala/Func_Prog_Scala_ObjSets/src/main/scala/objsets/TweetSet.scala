...
abstract class TweetSet {
  ...
  /**
   * A function to distinguish between Empty and Non-Empty subclass
   */
  def empty: Boolean
...
class Empty extends TweetSet {
  ...
  def mostRetweeted: Tweet = throw new java.util.NoSuchElementException("Empty tweets can't be retweeted")
